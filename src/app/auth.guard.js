System.register(['@angular/core', './api/session.service', "./api/auth.service"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, session_service_1, auth_service_1;
    var AuthGuard;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AuthGuard = (function () {
                function AuthGuard(sessionService, authService) {
